...
export const bookings = [
  ...
  },
  {
    ...
    end_time: moment().startOf("day").add(4, "day"),
  },
  {
    id: 5,
    group: 3,
  ...
  },
  {
    ...
    group: 4,
    title: "Jane Doe",
    start_time: moment().startOf("day").add(-2, "day"),
  ...
  },
  {
    ...
    group: 5,
    title: "John Doe",
    start_time: moment().add(-2.5, "day"),
    end_time: moment().add(1.5, "day"),
  },
  {
    id: 8,
    group: 6,
    title: "Jane Doe",
    start_time: moment().startOf("day").add(-0.25, "day"),
  ...
  },
  {
    ...
    end_time: moment().startOf("day").add(1.75, "day"),
  },
  {
    id: 13,
    group: 8,
